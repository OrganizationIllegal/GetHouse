         ...
         $.ajax({
	 		...
	 		data=$.parseJSON(data);
	 		    ...
	 		    for(var i=0;i<items.length;i++){
				    ...
				    defaultInfobox.setHtmlContent('<div id="infoboxText" style="background-color:White;min-height:100px;width:240px;"><img src="http://101.200.174.253:8080/projects/Elfin/The%20Elfin_%E9%A1%B9%E7%9B%AE_03.jpg" width="110" height="80" style="position:absolute;left:10px;top:10px;"><b id="infoboxTitle" style="position:absolute; top:10px; left:125px; width:250px;">项目价格：'+price+'</b><a id="infoboxDescription" style="position:absolute; top:30px; left:125px; width:250px;">项目名称:'+name+'</a></div>'); 
