...
<div id="houselist"  >
  ...
  <div class="btn-group" role="group">
     <button type="button" class="btn btn-inverse" style="background:-webkit-gradient(linear, 0% 0%, 0% 100%,from(#f6f6f8), to(rgb(171,171,171)));"><a href="/BingMap/OrderByPrice?order=1">价格从低到高</a></button>
  </div>
  <div class="btn-group" role="group">
    <button type="button" class="btn btn-inverse " style="background:-webkit-gradient(linear, 0% 0%, 0% 100%,from(#f6f6f8), to(rgb(171,171,171)));"><a href="/BingMap/OrderByPrice?order=2">价格从高到低</a></button>
  </div>
</div>
</div>
              ...
              total = InitTable(0);    //Load事件，初始化表格数据，页面索引为0（第一页）
                ...
                if(items!=null){
                	for(var j=0;j<items.length;j++){
                		//html+="<div><span style='font-family:微软雅黑;font-size:13px;font-weight:bolder'>"+items[j].project_address+"</span></div>";
                    	...
                    	//html+="<div class='media-body fnt-smaller' style='padding-left:8px'>";
                    	//html+="<span style='font-family:微软雅黑;font-weight:bolder;font-size:15px' class='media-heading'>"+items[j].project_name+"</span>";
                    	//html+="<h6>项目价格<span class='right' style='margin-right:20px'>"+items[j].project_min_price+"<span>-</span>"+items[j].project_high_price+"</span></h6>";
                    	//html+="<h6>可售套数<span class='right'  style='margin-right:20px'>"+items[j].keshou+"</span></h6>";
                    	//html+="<h6>平均单价<span class='right'  style='margin-right:20px'><span>$</span>"+items[j].average_price+"</span></h6>";
                    	//html+="<h6>房屋类型<span class='right'  style='margin-right:20px'>"+items[j].house_type+"</span></h6>";
                    	//html+="</div></div>";
                    	...
                    	html+="<div style='font-family:微软雅黑;font-size:13px'><span style='font-weight:bolder;'>均价</span><span class='right'  style='margin-right:14px'>"+items[j].average_price+"</span></div>";
                    	html+="</div></div></div>";
