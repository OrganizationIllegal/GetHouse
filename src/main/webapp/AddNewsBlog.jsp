...
<div class="container">
	...
	<form role="form" action="/NewsBlog/Add">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="publisher" placeholder="发布人" name="publisher">
	  </div>
	  <div class="form-group">
	  ...
	  <div class="form-group">
	    ...
	    <input type="text" class="form-control" id="abstract" placeholder="摘要" name="abstract">
	  </div>
	  <div class="form-group">
	    <label for="pic">图片</label>
	    <input type="text" class="form-control" id="pic" placeholder="图片" name="pic">
	  </div>
	  <div class="form-group">
	    <label for="detail">详情</label>
	    <input type="textarea" class="form-control" id="detail" placeholder="详情" name="detail">
	  </div>
